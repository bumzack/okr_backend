...
IMPORT_URL=(    "http://okr-backend:2323/api/v1/articles/import"    "http://okr-backend:2323/api/v2/articles/import"  )
SYSINFO_URL=(   "http://okr-backend:2323/api/v1/sysinfo"            "http://okr-backend:2323/api/v2/sysinfo"          )
