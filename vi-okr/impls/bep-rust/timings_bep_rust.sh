...
IMPORT_URL=("http://okr-backend:8000/api/v1/articles/import")
SYSINFO_URL=("http://okr-backend:8000/api/v1/sysinfo")
...
do
    URL=${SYSINFO_URL[i]}
    SYSINFO=$(curl  -s  ${URL} -H "Content-Type: application/json"  | jq )
