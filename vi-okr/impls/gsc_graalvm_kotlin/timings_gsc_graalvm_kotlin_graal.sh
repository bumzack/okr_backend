...
IMPORT_URL=(    "http://okr-backend:2325/api/v1/articles/import"     "http://okr-backend:2325/api/v2/articles/import"  )
SYSINFO_URL=(   "http://okr-backend:2325/api/v1g/sysinfo"            "http://okr-backend:2325/api/v2g/sysinfo"          )
