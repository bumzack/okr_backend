...
#include "controller/SysinfoController.hpp"
...
void MyControllerTest::onRun() {
  ...
  /* Add SysinfoController endpoints to the router of the test server */
  runner.addController(std::make_shared<SysinfoController>());
  ...
  runner.run([this, &runner] {
    ...
    /* Call server API */
    /* Call root endpoint of SysinfoController */
